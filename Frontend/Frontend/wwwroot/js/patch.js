...
;// CONCATENATED MODULE: ./Scripts/patch.ts


var container = document.getElementById("container");
var patch_frame = document.getElementById("frame");
var core = new Core(container, patch_frame);
core.Init();
core.Animate();
var layerItemHandle = external_Handlebars_namespaceObject.compile($("#layerItemTemplate").html());
for (var i = 0; i < 5; i++) {
